...
<body>
	...
	<form12:form action="${contextPath}/editAccount" method="post"
		modelAttribute="editaccountForm">

		<fieldset>
			<label for="username">Username:</label>
			<c:if test="${not empty editaccountForm.username}">
						<form12:hidden path="username"/> ${editaccountForm.username}
				</c:if>
